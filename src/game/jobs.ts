...
export const TAG_LABELS: Record<TagId, { noun: string; verbSingular: string; verbPlural: string }> = {
  ...
  shield: { noun: 'associated with shields', verbSingular: 'uses a shield', verbPlural: 'use shields' },
  ...
  'cast-bar': { noun: 'a cast bar job', verbSingular: 'has a cast bar', verbPlural: 'have cast bars' },
  'raid-buff': { noun: 'a raid buffer', verbSingular: 'gives a raid buff', verbPlural: 'give raid buffs' },
  backstep: { noun: 'a job with a backstep', verbSingular: 'has a backstep', verbPlural: 'have backsteps' },
  'auto-crit': {
  ...
  gridania: { noun: 'from Gridania', verbSingular: 'started in Gridania', verbPlural: 'started in Gridania' },
  limsa: { noun: 'from Limsa Lominsa', verbSingular: 'started in Limsa Lominsa', verbPlural: 'started in Limsa Lominsa' },
  uldah: { noun: "from Ul'dah", verbSingular: "started in Ul'dah", verbPlural: "started in Ul'dah" },
  ishgard: { noun: 'from Ishgard', verbSingular: 'started in Ishgard', verbPlural: 'started in Ishgard' },
};
